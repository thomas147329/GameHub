    ...
    def load_catalog(self, show_errors=False):
        try:
            ...
            if not isinstance(catalog, list):
                raise ValueError("The online game catalog is not a list.")
    ...
    def game_grid(self, games):
        ...
        for i, game in enumerate(games):
            ...
            tk.Button(card, text="PLAY" if installed else "DOWNLOAD",
                      command=lambda g=game: self.launch_game(g), bg=ACCENT,
                      fg="#101820", activebackground="#8bd4ff", bd=0,
                      padx=18, pady=6, font=("Helvetica", 10, "bold")).pack(pady=7)
    ...
    def launch_game(self, game):
        ...
        try:
            if not os.path.isfile(path):
                ...
                messagebox.showinfo("GameHub", "Downloaded " + game.get("name", "game") + "!")
